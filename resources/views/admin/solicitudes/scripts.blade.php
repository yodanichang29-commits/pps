...
const fotoHTML = s.user.foto 
    ? `<img src="/storage/${s.user.foto}" 
            ...
            class="w-auto h-32 sm:h-40 max-w-xs rounded-lg object-contain border-4 border-blue-500 shadow-lg">`
    : `<div class="w-24 h-32 sm:w-32 sm:h-40 bg-gradient-to-br from-blue-500 to-indigo-500 rounded-lg flex items-center justify-center text-white font-bold text-3xl sm:text-4xl border-4 border-blue-500 shadow-lg">
